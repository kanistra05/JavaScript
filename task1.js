...
let item_1 = '09.10.2021'
let item_2 = '10.10.2021'

// Написать функцию, которая найдет и выведет в консоль юзеров,
// зарегистрированных 09.10.2021 и 10.10.2021). Массив в task1.txt

function regusr (item_1, item_2){
    let regdate1 = users.filter(function (regd){
        return (regd.registrationDate == item_1)
        
    })
    let regdate2 = users.filter(function (regd){
        return (regd.registrationDate == item_2)
    })
    
    console.log(regdate1, regdate2)
}
regusr(item_1, item_2)